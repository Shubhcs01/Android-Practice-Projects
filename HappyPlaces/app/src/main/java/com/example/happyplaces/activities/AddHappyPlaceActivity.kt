...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (v!!.id) {
            ...
            R.id.btn_save -> {
                //Store the Datamodel to database
                when {
            ...
            R.id.tv_gps -> {
                ...
                if (!isLocationEnabled()) {
                    ...
                    // If location already turned ON, Then check for Permissions.
    ...
    private fun showRationalDialogForPermission() {
        AlertDialog.Builder(this)
            .setMessage("App needs this permission, Please Go To Settings and allowed the required Permission")
